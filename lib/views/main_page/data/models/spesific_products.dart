...
class SpesificProductsModel extends ResponseData {
  ...
  factory SpesificProductsModel.fromMap(Map<String, dynamic> map) {
    return SpesificProductsModel(
      data: map['data'] != null ? List<CategoryModel>.from(map['data']?.map((x) => CategoryModel.fromMap(x))) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory SpesificProductsModel.fromJson(String source) => SpesificProductsModel.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is SpesificProductsModel &&
