...
abstract class Styles {
  ...
  static final style400sp14Grey = TextStyle(
    color: ConstColor.greyColor,
    fontSize: 14.sp,
    fontWeight: FontWeight.w400,
    fontFamily: interFontFamily,
  ...
  static final style400sp20GreyUnderline = TextStyle(
      color: ConstColor.greyColor,
      fontSize: 20.sp,
      fontWeight: FontWeight.w400,
      fontFamily: interFontFamily,
  ...
  static final style400sp12Grey = TextStyle(
    color: ConstColor.greyColor,
    fontSize: 12.sp,
    fontWeight: FontWeight.w400,
    fontFamily: interFontFamily,
  ...
  static final style600sp18Black = TextStyle(
    color: ConstColor.mainBlack,
    fontSize: 18.sp,
    fontWeight: FontWeight.w600,
    fontFamily: interFontFamily,
  ...
  static final styles700sp22Black = TextStyle(
    color: ConstColor.mainBlack,
    fontSize: 22.sp,
    fontWeight: FontWeight.w700,
    fontFamily: interFontFamily,
